import{o as L}from"./assets/mob-menu-fc4d99a8.js";import"./assets/vendor-8cce9181.js";const w=document.querySelector(".favorites-page-items-not-found"),l=document.querySelector(".favorites-page-items-gallery"),y=document.querySelector(".favorites-page-items"),r=document.querySelector(".favorites-mobile-pagination"),S=new URL("/team-02-jsproject/assets/sprite-7048d1fb.svg#icon-arrow",self.location),g="favorites",$=localStorage.getItem(g),p=JSON.parse($),x=new URL("/team-02-jsproject/assets/sprite-7048d1fb.svg#icon-lighticon",self.location),E=new URL("/team-02-jsproject/assets/sprite-7048d1fb.svg#icon-trash",self.location),n=8;let d=1,o=d*n,c=o-n,a="",f,v,b,m=Math.ceil(p.length/n);function h(t){t.style.display="none",t===l&&innerWidth>768&&(y.style.paddingRight="48px")}function k(t){t.style.display="flex",t===l&&innerWidth>768&&(y.style.paddingRight="0")}window.innerWidth<768&&k(r);function u(t){l.innerHTML="";const i=t.reduce((e,s)=>e+`<li class="gallery-list-item">
