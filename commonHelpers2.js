import{o as j}from"./assets/mob-menu-1d0d75a8.js";/* empty css                      */import{i as y,a as $}from"./assets/vendor-8cce9181.js";const S=document.querySelector(".back-to-top"),q=()=>{const e=Math.max(document.documentElement.scrollTop,document.body.scrollTop);e>0&&(window.requestAnimationFrame(q),window.scrollTo(0,e-e/8))};S.addEventListener("click",q);window.addEventListener("scroll",()=>{(window.pageYOffset||document.documentElement.scrollTop||document.body.scrollTop)>350?S.classList.add("active"):S.classList.remove("active")});var F=document.getElementById("myAudio");F.addEventListener("ended",function(){y.show({title:"Lets do it!",message:"Subscribe in the bottom, and learn about new exercises!",position:"bottomCenter",timeout:1e4,backgroundColor:"var( --dark-gray-hover)",messageColor:"var( --white-smoke)"})});const f=document.querySelector(".exercises-gallery-label"),l=document.querySelector(".exercises-gallery-group"),p=document.querySelector(".exercises-gallery-filter"),g=document.querySelector(".page-buttons-container");let c=null;const m=document.createElement("span"),C=document.querySelector("#filtre-key"),b=document.querySelector(".search-tool"),O=new URL("/team-02-jsproject/assets/sprite-7048d1fb.svg#icon-arrow",self.location),M=document.querySelector(".error-card-message"),D="https://energyflow.b.goit.study/api/";let u=1;const i={content:null,title:null},I="https://energyflow.b.goit.study/api/filters";let a={filter:"Muscles",page:1,limit:8},h="filter";const A="muscles",W=$.create({baseURL:I});function B(e){l.innerHTML="";const t=e.results.map(r=>`<li class="exercises-item-background">
      <a href="${r.imgUrl}">
      <div>
        <img
